...
urlpatterns = patterns('',
    ...
    url(r'^allbattles', 'battles.views.allbattles', name='allbattles'),
    ...
    url(r'^createbattle', 'battles.views.createbattle', name='createbattle'),
    url(r'^joinbattle', 'battles.views.joinbattle', name='joinbattle'),
