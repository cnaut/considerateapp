...
public class TotalTimeFragment extends Fragment {
    ...
    //Used to update the text on the top of the graph, since it updates every second
    ...
    // Used to update the chart, since it updates less frequently
    ...
    private void update() {
        ...
        //Translate the stored history into a format that the chart likes
        Date today = new Date();
