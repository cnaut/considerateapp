﻿if (navigator.userAgent.toLowerCase().match(/android/)) {
	document.write("<script type='text\/javascript' scharset='utf-8' src='android\/cordova-1.5.0.js'><\/script>");
	...
	document.write("<script type='text\/javascript' charset='utf-8' src='wp\/cordova-1.5.0.js'><\/script>");
