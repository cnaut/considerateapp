...
public class ConsiderateAppActivity extends Activity {
	...
	class timerClearTask extends TimerTask {
		public void run() {
			...
			// graphString =
			// "<img src='http://chart.apis.google.com/chart?chtt=Number+of+Unlocks&amp;chts=ffffff,12&amp;chs=300x150&amp;chf=bg,s,000000|c,s,000000&amp;chxt=x,y&amp;chxl=0:|T-5|T-4|T-3|T-2|T-1|1:|0|"
			// + (double)((double)max/2.0) + "|" + max +
			// "&amp;cht=lxy&amp;chd=t:0.00,25.00,50.00,75.00,100.00|" +
			// plotPoints +
			// "&amp;chco=ffff00&amp;chm=o,ffff00,0,0.0,10|o,ffff00,0,1.0,10|o,ffff00,0,2.0,10|o,ffff00,0,3.0,10|o,ffff00,0,4.0,10' alt='Google Chart'/>";
	...
	/*
	 * public class StopWatch { private long startTime = 0; private long
	 * stopTime = 0; private boolean running = false; private long totalTime =
	 * 0;
	 * 
	 * public long getTotalTime() { if (this.running) { long elapsed =
	 * this.totalTime + (System.currentTimeMillis() - this.startTime); return
	 * elapsed; } return this.totalTime; }
	 * 
	 * public void setTotalTime(long setTime) { this.totalTime = setTime; }
	 * 
	 * public void start() { this.startTime = System.currentTimeMillis();
	 * this.running = true; }
	 * 
	 * public void stop() { //if phone starts off in SCREEN_OFF state if
	 * (this.startTime == 0) { return; }
	 * 
	 * this.stopTime = System.currentTimeMillis(); this.running = false;
	 * 
	 * long elapsed = this.stopTime-this.startTime; this.totalTime =
	 * this.totalTime + elapsed;
	 * 
	 * this.startTime = 0; this.stopTime = 0; }
	 * 
	 * }
	 */
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		Intent flipService = new Intent(getApplicationContext(),
				FlipService.class);
	...
	protected void startSleepMonitor() {
		Intent sleepMonitorIntent = new Intent(getApplicationContext(),
				SleepMonitorService.class);
		startService(sleepMonitorIntent);
		Toast.makeText(getApplicationContext(),
				"Lockscreen is currently being replaced.", Toast.LENGTH_SHORT)
				.show();
	}
	...
	protected void stopSleepMonitor() {
		...
		Toast.makeText(getApplicationContext(),
				"Lockscreen is no longer being replaced.", Toast.LENGTH_SHORT)
				.show();
	}
}
